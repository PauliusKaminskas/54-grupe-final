...
export function RegisterForm() {
        ...
        fetch('http://localhost:5417/api/register', {
            ...
            .then((data) => {
                ...
                if (data.status === 'success') {
                    setAlertText(
                        'Sėkmingai prisiregistravote! Po 3 sekundžių būsite perkelti į prisijungimo puslapį.'
                    );
    ...
    return (
        <form
            ...
            className="col-12 col-md-10 col-lg-6 col-xl-5 col-xxl-4"
        >
            {alertText && (
                <div
                    className={`alert alert-${alertStatus} alert-dismissible fade show`}
                    role="alert"
                >
                    {alertText}
                    <button
